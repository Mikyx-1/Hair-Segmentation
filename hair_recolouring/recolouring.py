...
sys.path.insert(0, ".")
from models.hair_segmentation.HairSegmentationBiseNet_ONNX import (
    HairSegmentationBiseNet_ONNX,
)
from models.yolo.YoloEnd2EndONNX import YoloEnd2EndONNX
from utils.makeup.hair_color import change_hair_color_ver2, change_hair_color_ver6
...
def test_changing_hair_color(
    ...
    version: int,
    color_name: str,
    hair_segmentation_model_path: str = "saved_weights/hair_segmentaion/hairsegmentation_bisenet.onnx",
    yolo_model_path: str = "saved_weights/yolo/yolov6n_end2end.onnx",
